...
SELECT ID, UserID, Date, RiskLevel, Name, Description, Cost FROM InvestmentIdeaTable WHERE (ID = @ID)";
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LoginEntries] WHERE (([ID] = @Original_ID) AND ([Username] = @" +
                "Original_Username) AND ([Is_RelationshipManager] = @Original_Is_RelationshipMana" +
                "ger))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LoginEntries] ([Username], [Email], [Password], [Is_RelationshipManager]) VALUES (@Username, @Email, @Password, @Is_RelationshipManager);
SELECT ID, Username, Email, Password, Is_RelationshipManager FROM LoginEntries WHERE (ID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LoginEntries] SET [Username] = @Username, [Email] = @Email, [Password] = @Password, [Is_RelationshipManager] = @Is_RelationshipManager WHERE (([ID] = @Original_ID) AND ([Username] = @Original_Username) AND ([Is_RelationshipManager] = @Original_Is_RelationshipManager));
SELECT ID, Username, Email, Password, Is_RelationshipManager FROM LoginEntries WHERE (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int Delete(int Original_ID, string Original_Username, int Original_Is_RelationshipManager) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_Is_RelationshipManager));
        ...
        public virtual int Insert(string Username, string Email, string Password, int Is_RelationshipManager) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(Is_RelationshipManager));
        ...
        public virtual int Update(string Username, string Email, string Password, int Is_RelationshipManager, int Original_ID, string Original_Username, int Original_Is_RelationshipManager, int ID) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Is_RelationshipManager));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_Is_RelationshipManager));
